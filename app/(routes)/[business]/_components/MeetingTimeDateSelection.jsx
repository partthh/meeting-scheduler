...
function MeetingTimeDateSelection({ eventInfo, businessInfo }) {
    ...
    const sendEmail = (user) => {
        ...
        console.log("Email HTML:", emailHtml);  // Check the type of emailHtml
        console.log("Type of emailHtml:", typeof emailHtml);  // This should be 'string'

        if (typeof emailHtml !== 'string') {
            console.error("Rendered email is not a string!");
            setLoading(false);
            return;
        }
