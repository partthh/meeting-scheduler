...
function CreateBusiness() {
  ...
  const onCreateBusiness=async()=>{
      ...
      await setDoc(doc(db,'Business',user.email),{
          businessName:businessName.replace("Business",businessName),
          email:user.email,
  ...
  return (
    <div className='p-14 items-center flex flex-col gap-20 my-10'>
      ...
      <div className='flex flex-col items-center gap-4 max-w-3xl'>
        ...
        <p class Name='text-slate-500'>You can always change this later from settings</p>
        <div className='w-full'>
          <label className='text-slate-400'>Team Name</label>
          <Input placeholder="Ex.Parth Chugh" 
          className="mt-2"
